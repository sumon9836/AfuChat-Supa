...
const s = StyleSheet.create({
  ...
  shareTabs: { flexDirection: "row", borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, padding: 4, marginBottom: 10 },
  ...
  stepsCard: { borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, padding: 16, gap: 0 },
...
const stepStyles = StyleSheet.create({
  ...
  content: { flex: 1, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, padding: 12, marginBottom: 8 },
...
const invS = StyleSheet.create({
  ...
  contactRow: { flexDirection: "row", alignItems: "center", paddingVertical: 10, gap: 10, borderTopWidth: StyleSheet.hairlineWidth },
