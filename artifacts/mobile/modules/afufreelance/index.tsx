...
const s = StyleSheet.create({
  ...
  subHeader: { flexDirection: "row", alignItems: "center", paddingHorizontal: 12, paddingVertical: 12, borderBottomWidth: 0.5, gap: 10 },
  ...
  reviewRow: { paddingTop: 12, marginTop: 12, borderTopWidth: 0.5, gap: 4 },
  reviewHandle: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  actionBar: { position: "absolute", bottom: 0, left: 0, right: 0, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20, paddingTop: 14, borderTopWidth: 0.5 },
