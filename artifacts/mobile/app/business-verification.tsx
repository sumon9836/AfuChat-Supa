...
const st = StyleSheet.create({
  ...
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.45)", justifyContent: "flex-end", paddingHorizontal: 8, paddingBottom: 8 },
  pickerSheet: { borderTopLeftRadius: 22, borderTopRightRadius: 22, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, paddingTop: 12, paddingBottom: 40, maxHeight: "80%" },
