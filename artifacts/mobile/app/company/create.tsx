...
const styles = StyleSheet.create({
  root: { flex: 1 },
  nav: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingBottom: 12, borderBottomWidth: 0.5 },
  ...
  progressBar: { paddingHorizontal: 20, paddingVertical: 12, borderBottomWidth: 0.5 },
  ...
  bottomBar: { paddingHorizontal: 16, paddingTop: 12, flexDirection: "row", gap: 10, borderTopWidth: 0.5 },
  ...
  pickerOption: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14, borderBottomWidth: 0.5 },
  ...
  regResultRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 0.5 },
