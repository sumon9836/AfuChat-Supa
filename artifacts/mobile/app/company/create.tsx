...
const styles = StyleSheet.create({
  ...
  pickerSheet: { borderTopLeftRadius: 22, borderTopRightRadius: 22, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, padding: 20, paddingBottom: 40, maxHeight: "70%" },
