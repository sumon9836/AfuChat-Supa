...
const styles = StyleSheet.create({
  ...
  shopGroupHeader: { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, borderBottomWidth: 0.5, borderBottomColor: "rgba(0,0,0,0.06)" },
  shopGroupLogo: { width: 30, height: 30, borderRadius: 8 },
  shopGroupName: { flex: 1, fontSize: 14, fontFamily: "Inter_700Bold" },
  cartItem: { flexDirection: "row", alignItems: "flex-start", gap: 12, padding: 14, borderTopWidth: 0.5 },
  ...
  checkoutPanel: { position: "absolute", bottom: 0, left: 0, right: 0, borderTopWidth: 0.5, padding: 16, gap: 10 },
  summaryRows: { gap: 6 },
  summaryRow: { flexDirection: "row", justifyContent: "space-between" },
  summaryLabel: { fontSize: 13, fontFamily: "Inter_400Regular" },
  summaryVal: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  totalSummaryRow: { paddingTop: 8, marginTop: 4, borderTopWidth: 0.5, borderTopColor: "rgba(0,0,0,0.1)" },
