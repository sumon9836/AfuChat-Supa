...
const st = StyleSheet.create({
  ...
  statsRow: { flexDirection: "row", borderTopWidth: 0.5, paddingTop: 12, marginBottom: 8 },
  statItem: { flex: 1, alignItems: "center" },
  statValue: { fontSize: 16, fontFamily: "Inter_700Bold" },
  statLabel: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 2 },
  shopDesc: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20, paddingTop: 10, marginTop: 2, borderTopWidth: 0.5 },
  addressRow: { flexDirection: "row", alignItems: "center", gap: 5, paddingTop: 10, marginTop: 8, borderTopWidth: 0.5 },
  ...
  productsHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 16, paddingBottom: 10, borderBottomWidth: 0.5, marginBottom: 12 },
