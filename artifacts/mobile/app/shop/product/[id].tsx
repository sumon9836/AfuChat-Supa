...
const st = StyleSheet.create({
  ...
  checkoutOverlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.5)", paddingHorizontal: 8, paddingBottom: 8 },
  checkoutCard: { borderTopLeftRadius: 24, borderTopRightRadius: 24, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, maxHeight: "90%", paddingHorizontal: 20, paddingTop: 12, paddingBottom: 0 },
