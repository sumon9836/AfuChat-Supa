...
const styles = StyleSheet.create({
  ...
  resultOverlay: { ...StyleSheet.absoluteFillObject, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.65)", paddingHorizontal: 8, paddingBottom: 8 },
  resultCard: { borderTopLeftRadius: 28, borderTopRightRadius: 28, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, padding: 24, gap: 14 },
  ...
  modalOverlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.55)", paddingHorizontal: 8, paddingBottom: 8 },
  modalContent: { borderTopLeftRadius: 28, borderTopRightRadius: 28, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, padding: 24, gap: 14 },
