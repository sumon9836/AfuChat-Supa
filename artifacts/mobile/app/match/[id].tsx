...
const styles = StyleSheet.create({
  ...
  panel: { borderTopWidth: 0.5, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 10 },
  ...
  emojiPanel: { borderTopWidth: 0.5, height: EMOJI_PANEL_HEIGHT },
  emojiTabs: { flexDirection: "row", borderBottomWidth: 0.5, borderBottomColor: "#3A3A3C" },
