...
const styles = StyleSheet.create({
  ...
  modalBackdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "flex-end", paddingHorizontal: 8, paddingBottom: 8 },
  reportSheet: { borderTopLeftRadius: 24, borderTopRightRadius: 24, borderBottomLeftRadius: 14, borderBottomRightRadius: 14, padding: 20, paddingBottom: 34 },
